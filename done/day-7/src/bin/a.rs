...
impl Hand {
    fn new(line: &str) -> Self {
        ...
        let hand_type = if duplicates.len() == 1 && duplicates[0] == 4 {
            HandType::FiveOfAKind
        } else if duplicates.len() == 1 && duplicates[0] == 3 {
            HandType::FourOfAKind
        } else if duplicates.len() == 2 && duplicates[0] != duplicates[1] {
            HandType::FullHouse
        } else if duplicates.len() == 1 && duplicates[0] == 2 {
            HandType::ThreeOfAKind
        } else if duplicates.len() == 2 && duplicates[0] == 1 && duplicates[1] == 1 {
            HandType::TwoPairs
        } else if duplicates.len() == 1 && duplicates[0] == 1 {
            HandType::OnePair
...
fn test() {
    setup_tracing();
    assert_eq!(6440, get_answer("test"));
}
